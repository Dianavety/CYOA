...
class Worldbuilder {
  ...
  public static void main() {
    ...
    Rooms Historyrm = new Rooms("History Room", new ArrayList<>(Arrays.asList("new mars map","window", "radio", "desk","desk drawer","historical document", "half drunk caramel iced coffee", "family stock photo")));
    ...
    Rooms East1rm = new Rooms("East1 Room", new ArrayList<>(Arrays.asList("fridge","knife","scrub daddy","orange juice","bag of apples", "kitchen drawer","baby humanoids")));
    ...
    Rooms Closet = new Rooms("Closet", new ArrayList<>(Arrays.asList("acid", "tape", "batteries", "flyer", "box cutter")));
